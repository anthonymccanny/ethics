...
# TODO: These descriptives should use sampling weights
...
```{r}
#TODO: Average within years and then across years to account for differences in sample size (?)
...
#TODO: Fix the use of w_WP16 in the following code, it causes issues in Prioritarianism, 90/10 and Gini. The weights need to be included in a different way.
#TODO: Calculate aggregates within years and then average across years, otherwise sample size differences cause bias, and for measures of dispersion changes in wellbeing across years is penalized
